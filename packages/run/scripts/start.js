...
const devServer = JSON.parse(process.env.FIG_CONFIG).devServer || {};
// const { devServer = {} } = userWebpackConfig
const DEFAULT_PORT = parseInt(process.env.PORT, 10) || devServer.port || 3000;
const HOST = process.env.HOST || devServer.host || "0.0.0.0";
...
checkBrowsers(paths.appPath, isInteractive)
  ...
  .then((port) => {
    ...
    const devServer = new WebpackDevServer(
      compiler,
      Object.assign(serverConfig, config.devServer || {})
    );
    ...
    devServer.listen(port, HOST, (err) => {
      ...
      console.log(chalk.cyan(`${urls.localUrlForTerminal}\n`));
